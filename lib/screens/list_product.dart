import 'package:amajon_mobile/screens/detail_product.dart';
          ...
          if (snapshot.data == null) {
            ...
            if (!snapshot.hasData) {
              return const Column(
                children: [
                  Text(
                    'Belum ada data product pada Amajon Mobile.',
                      ...
                      GestureDetector(
                        ...
                        child: Text(
                          ...
                          style: const TextStyle(
                            ...
                            color: Colors.blue, // Tambahkan warna biru untuk menandai link
                          ),
                        ),
                      ),
